...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowFrontend",
        policy =>
        {
            policy.WithOrigins("http://localhost:5173", "http://localhost:3000", "http://serkof.com")
            .AllowAnyHeader()
            .AllowAnyMethod()
            .AllowCredentials();
        });
...
builder.Services.AddScoped<backend.Data.IAppDbContext>(sp => sp.GetRequiredService<AppDbContext>());

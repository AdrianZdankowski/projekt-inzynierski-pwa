...
const CHUNK_SIZE = (parseInt(import.meta.env.VITE_CHUNK_SIZE || '4', 10) || 4) * 1024 * 1024; // 4 MB default
const CHUNK_THRESHOLD = (parseInt(import.meta.env.VITE_CHUNK_THRESHOLD || '4', 10) || 4) * 1024 * 1024; // 4 MB default
